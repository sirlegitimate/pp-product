...
const questions = {
    math: {
        l1: {
            ...
            q1: {
                question: "If Joe has 1 banana, and Myrtle has 4 bananas, how many bananas do they have in total?",
                answer: 5,
                timer: 15
            },
            q2: {
        ...
        l5: {
            info: {
                ...
                content: "<h3>Negative numbers are marked by a - before them.</h3><h3>Imagine if your friend owes you 4 candies, but you don't have them yet; you can think of it as having -4 candies.</h3><h3>Adding a negative number to a different number is just like substracting that number from the other number.</h3><h3>5 + (-3) = 2</h3><h3>5 - 3 = 2</h3><h3>Since it's negative, you're going back by 3 when adding it. A + and - symbol next to each other are a -.</h3><h3>As for substracting negative numbers, if there are two - symbols next to each other, they cancel each other out and become a + symbol, meaning that you can add the two numbers together as normal.</h3><h3>5 - (-3) = 8</h3><h3>5 + 3 = 8</h3><h3>Two minus symbols next to each other are a plus.</h3><h3>If a number is too small to be substracted from, you can go back until you start counting from 0 again. Once you reach 0, you can count into the negatives, starting with -1 and going down until you reach your desired number.</h3><h3>2 - 4 = -2</h3><h3>As for multiplication and division, if you multiply a negative number by a negative number, the end result will be a positive number (just ignore the -).</h3><h3>(-5) × (-5) = 25</h3><h3>If you multiply a negative number by a positive number, the end result will be a negative number (just add a -).</h3><h3>5 ÷ (-5) = -1</h3><h2>Win condition: 8 score</h2>",
                minScore: 8
            },
            q1: {
            ...
            q5: {
                question: "What is 40 + (-70) + 20?",
                answer: -10,
                timer: 15
            },
            q6: {
                question: "What is (-50) + 60 - (-10)?",
                answer: 20,
                timer: 15
            },
            q7: {
